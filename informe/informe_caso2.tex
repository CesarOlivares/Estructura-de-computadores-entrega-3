...
Este informe usa vocabulario de dos mundos distintos —el de la planta y el de
los sistemas distribuidos— y conviene fijar los dos antes de empezar, porque
...
\begin{itemize}[leftmargin=*, itemsep=2pt]
  ...
  \item \textbf{\emph{Lead time}:} el total, de punta a punta — desde que se
...
que crece significa que la etapa \textbf{no da abasto}. Son cosas distintas, y
...
\textbf{balanceador} delante de ellas: una pieza intermedia que recibe cada
tarea y decide a qué réplica mandársela. Decidimos —y es una
...
\textbf{Versión no atómica (commiteada con el defecto, a propósito).} Reclamar
...
(la alternativa clásica) porque elimina la
ventana en vez de administrarla: no hay TTL que expire a mitad de un ciclo ni
liberación de lock que se pueda olvidar. La función de un ``lock/contador
...
No existe una definición única de cuello de botella que sirva para cualquier
línea, así que había que elegir una y defenderla. El criterio es una
...
El sistema resuelve el caso de punta a punta y sus afirmaciones
